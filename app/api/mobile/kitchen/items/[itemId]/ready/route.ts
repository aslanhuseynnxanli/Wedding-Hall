...
export async function POST(
  ...
  try {
    ...
    /*
     * Mobil tətbiqdən göndərilən Supabase
     * access tokenini yoxlayırıq.
     */
    const accessToken =
    ...
    /*
     * Hazır ediləcək məhsulu tapırıq.
     */
    const {
      data: item,
      error: itemError,
    ...
    /*
     * İstifadəçinin həmin restoranda
     * mətbəx rolu olduğunu yoxlayırıq.
     */
    const {
      data: userRoleRows,
      error: userRoleError,
    ...
    /*
     * Artıq READY edilibsə ikinci dəfə
     * push göndərmirik.
     */
    ...
    /*
     * Məhsulun aid olduğu sifarişi və
     * ofisiant məlumatını tapırıq.
     */
    const {
      data: order,
      error: orderError,
    ...
    /*
     * Push xətası status dəyişikliyini
     * geri qaytarmır.
     */
    let pushResult: {
